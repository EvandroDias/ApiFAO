...
{
    public class SalvarFuncionarioCommands : Notifiable, IComand
    {
        ...
        //public IList<ItemFuncaoFuncionarioCommands> Item { get; set; }
        ...
        public bool IsValid()
        {
            ...
            AddNotifications(new Contract()
                ...
                .IsNotNullOrEmpty(FuncaoId, "Função", "O campo função é obrigatório!")
