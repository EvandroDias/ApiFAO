...
{
    public class AlterarTurmaCommands : Notifiable, IComand
    {
        ...
        public bool IsValid()
        {
            ...
            AddNotifications(new Contract()
                ...
                .IsNotNullOrEmpty(Coordenador, "Coordenador", "O Coordenador(a) é obrigatório!")
                .IsNotNullOrEmpty(Diretor, "Diretor", "O diretor(a) é obrigatório!")
